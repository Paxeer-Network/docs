...
[HyperPaxeer Security](mailto:security@HyperPaxeer.org), which is a third-party security platform that helps us identify, triage,
and resolve security issues in a confidential and secure manner. For non-sensitive bugs, we encourage users to file an
open ticket on our [HyperPaxeer Github Repo](https://github.com/Paxeer-Network/Paxeer-Network) so that our team can address the issue as quickly
as possible.
