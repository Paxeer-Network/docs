...
This document specifies the internal `x/epochs` module of the HyperPaxeer Hub.
...
Other HyperPaxeer modules can then register logic to be executed at the timer ticks.
