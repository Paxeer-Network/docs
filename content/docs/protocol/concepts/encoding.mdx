...
previous versions, specially for client encoding and signing with Ledger devices. HyperPaxeer does not
...
allows for quick reconstruction of encoded data. HyperPaxeer uses RLP to encode/decode Ethereum
