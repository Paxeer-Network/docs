...
Find the [Solidity interface in the HyperPaxeer/extensions repo](https://github.com/Paxeer-Network/extensions/blob/main/precompiles/stateful/Distribution.sol).

### ABI

Find the [ABI in the HyperPaxeer/extensions repo](https://github.com/Paxeer-Network/extensions/blob/main/precompiles/abi/distribution.json).
...
```solidity
import "https://github.com/Paxeer-Network/extensions/blob/main/precompiles/stateful/Distribution.sol";
```
