...
Find the [Solidity interface in the HyperPaxeer/extensions repo](https://github.com/Paxeer-Network/extensions/blob/main/precompiles/stateful/Staking.sol).

### ABI

Find the [ABI in the HyperPaxeer/extensions repo](https://github.com/Paxeer-Network/extensions/blob/main/precompiles/abi/staking.json).
...
```solidity
import "https://github.com/Paxeer-Network/extensions/blob/main/precompiles/stateful/Staking.sol";
```
...
/// @param _amount The amount of tokens to stake in ahpx.
...
/// @param _validatorAddr The address of the validator.
/// @param _amount The amount of tokens to unstake in ahpx.
...
/// @param _amount The amount of tokens to redelegate in ahpx.
...
/// @param _validatorAddr The address of the validator.
/// @param _amount The amount of tokens to cancel the unbonding delegation in ahpx.
